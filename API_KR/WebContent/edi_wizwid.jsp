...
<%
	...
	*/
	...
	//String wizwid_connip = "http://220.117.243.72"; //LIVE
	String wizwid_connip = "http://api.wizwid.com"; //LIVE
	String wizwid_connip2 = "http://220.117.243.73"; //LIVE
	int statusCode = 0;
	...
	if(dbmode.equals("") || dbmode == null){
		...
		if(command.equals("OrderRetrieve")){
			...
			cs.setRecvLog(dbmode, inuser, command,command, "N/A",
					CommonUtil.getCurrentDate(), CommonUtil.getCurrentDate(), "500", "It's wrong cammand!", transCD);
		}
	}
